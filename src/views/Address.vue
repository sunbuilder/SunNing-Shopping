          ...
          <div class="checkout-addr">
            ...
            <div class="check-step">
              <ul>
                ...
                <li><span>查看 你的</span> 订单</li>
                <li><span>选择</span>付款</li>
                <li><span>订购</span> 认证书</li>
              </ul>
            </div>
            ...
            <!-- shipping method-->
            <div class="page-title-normal checkout-title">
              <h2><span>选择邮寄方式</span></h2>
            </div>
            <div class="shipping-method-wrap">
              <div class="shipping-method">
                <ul>
                  <li class="check">
                    <div class="name">免运费</div>
            ...
            <div class="next-btn-wrap">
              <router-link class="btn btn--m btn--red" v-bind:to="{path:'orderConfirm',query:{'addressId':selectedAddrId}}">继续</router-link>
            </div>
          </div>
        </div>
      </div>
